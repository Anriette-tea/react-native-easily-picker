...
var Picker = react_1["default"].forwardRef(function (properties, ref) {
    ...
    var Header = (<react_native_1.View style={{ height: (300 - optionHeight) / 2, flex: 1 }}></react_native_1.View>);
    var Footer = (<react_native_1.View style={{ height: (300 - optionHeight) / 2, flex: 1 }}></react_native_1.View>);
    var lineStyle = {
